...
6. **取得結果の表示**
   - 以下の5つのレポートデータを要約した結果をマークダウン形式でユーザーに表示する：
     - STEP3-2の日別広告レポート取得結果
     - STEP3-2の媒体別広告レポート取得結果
     - STEP3-3のキャンペーン別広告レポート取得結果（並列取得された全mediaの結果）
     - STEP3-4のキーワード別広告レポート取得結果（並列取得された全mediaの結果）
     - STEP3-5の検索クエリ別広告レポート取得結果（並列取得された全mediaの結果）
